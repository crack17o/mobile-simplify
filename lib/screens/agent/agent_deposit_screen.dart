...
/// Dépôt wallet (caisse) — POST /api/agent/wallet/deposit/
/// phone, amount, reference (optionnel)
class AgentDepositScreen extends StatefulWidget {
  final AppUser user;
  final String phone;

  const AgentDepositScreen({super.key, required this.user, required this.phone});

  @override
  State<AgentDepositScreen> createState() => _AgentDepositScreenState();
}

class _AgentDepositScreenState extends State<AgentDepositScreen> {
  ...
  Widget build(BuildContext context) {
    if (_success && _result != null) {
      ...
      return Scaffold(
        ...
        appBar: AppBar(title: const Text('Dépôt effectué'), backgroundColor: AppTheme.sidebarBackground, foregroundColor: AppTheme.sidebarForeground),
        body: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('Dépôt réussi', style: Theme.of(context).textTheme.titleLarge?.copyWith(color: AppTheme.sidebarForeground)),
